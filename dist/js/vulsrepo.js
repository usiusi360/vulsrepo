...
var demo = [
                ...
                },
                {
                        ...
                        value : '{"derivedAttributes":{},"aggregators":{},"renderers":{},"hiddenAttributes":[],"menuLimit":3000,"cols":["Container"],"rows":["Packages","CveID","Summary"],"vals":[],"exclusions":{"Container":["centos_5.1","centos_5.2","centos_5.4","centos_5.6","centos_5.7","centos_5.8","centos_5.9","centos_5.10","centos_5.11","None"]},"inclusions":{"Container":["centos_6.0","centos_6.1","centos_6.2","centos_6.3","centos_6.4","centos_6.5","centos_6.6","centos_6.7","centos_6.8"]},"unusedAttrsVertical":85,"autoSortUnusedAttrs":false,"rendererOptions":{"localeStrings":{"renderError":"An error occurred rendering the PivotTable results.","computeError":"An error occurred computing the PivotTable results.","uiRenderError":"An error occurred rendering the PivotTable UI.","selectAll":"Select All","selectNone":"Select None","tooMany":"(too many to list)","filterResults":"Filter results","totals":"Totals","vs":"vs","by":"by"}},"localeStrings":{"renderError":"An error occurred rendering the PivotTable results.","computeError":"An error occurred computing the PivotTable results.","uiRenderError":"An error occurred rendering the PivotTable UI.","selectAll":"Select All","selectNone":"Select None","tooMany":"(too many to list)","filterResults":"Filter results","totals":"Totals","vs":"vs","by":"by"},"aggregatorName":"Count","rendererName":"Heatmap","inclusionsInfo":{"Container":["centos_6.0","centos_6.1","centos_6.2","centos_6.3","centos_6.4","centos_6.5","centos_6.6","centos_6.7","centos_6.8"]}}'
		},
		{
			key : '3. ScanTime Diff',
